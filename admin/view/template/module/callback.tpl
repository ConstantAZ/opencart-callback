  ...
  <div class="box">
    ...
    <div class="content">    
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
        <tr>
        <td><label for="email_to"><?php echo $setting_email_to?></label></td>
        <td><input id="email_to" type="text" name="email_to" value="<?php if(isset($email_to)){echo $email_to;} ?>">
        <span style="font-size:10px; color:#777;"><?php echo $info_email_to; ?></span>
        <?php if ($error_email) { ?>
        <span class="error"><?php echo $error_email; ?></span>
        <?php } ?></td>
        </tr>
        <tr>
        <td><label for="use_captcha"><?php echo $setting_use_captcha?></label></td>
        <td>
        <input id="use_captcha" type="checkbox" name="use_captcha" value="1" <?php if($use_captcha){ echo 'checked="checked"'; } ?>>
        <span style="font-size:10px; color:#777;"><?php echo $info_use_captcha; ?></span>
        </td>
        </tr>
        </table>        
